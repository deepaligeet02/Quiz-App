...
public class cloud extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        questionList = dbHelper.getAllQuestion_TABLE2();
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(cloud.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void finishQuiz() {
        Intent intent = new Intent(cloud.this, score.class);
    ...
    private void startTimer() {
        timer = new CountDownTimer(timeLeftInMillis, COUNTDOWN_INTERVAL) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(cloud.this, "Times Up!!", Toast.LENGTH_SHORT).show();
            }
        }.start();
    }
