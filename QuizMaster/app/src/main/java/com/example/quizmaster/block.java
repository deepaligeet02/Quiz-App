...
public class block extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonConfirmNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!answered) {
                    // wrongans++;
                    //textViewScore.setText("Correct: " + String.valueOf(wrongans));
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        checkAnswer();
                    } else {
                        // wrongans++;
                        // textViewScore.setText("Correct: " + String.valueOf(wrongans));
                        Toast.makeText(block.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void finishQuiz() {
        Intent intent = new Intent(block.this, score.class);
    ...
    private void startTimer() {
        timer = new CountDownTimer(timeLeftInMillis, COUNTDOWN_INTERVAL) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(block.this, "Times Up!!", Toast.LENGTH_SHORT).show();
            }
        }.start();
    }
