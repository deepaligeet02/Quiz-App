...
public class doker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dokeractivity);
        ...
        questionList = dbHelper.getAllQuestion_TABLE3();
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked() || rb4.isChecked()) {
                        ...
                        Toast.makeText(doker.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void finishQuiz() {
        ...
        Intent intent = new Intent(doker.this, score.class);
    ...
    private void startTimer() {
        timer = new CountDownTimer(timeLeftInMillis, COUNTDOWN_INTERVAL) {
            ...
            public void onFinish() {
                ...
                Toast.makeText(doker.this, "Times Up!!", Toast.LENGTH_SHORT).show();
            }
        }.start();
    }
